...
with st.sidebar:
    ...
    # Show API status (locked/hidden from users)
    if api_configured:
...
if image is not None:
    ...
    if not api_configured:
        ...
        st.info("Please contact the administrator to configure the API key.")
    else:
        ...
        if analyze_btn:
            ...
            try:
                ...
                st.info("💡 **Troubleshooting:** Try Debug Mode to see processing steps or check if the image contains visible particles.")
